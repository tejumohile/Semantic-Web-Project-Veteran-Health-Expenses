...
public class SparqlQueryMachine {
	String dataset1150NameSpace = "http://logd.tw.rpi.edu/source/data-gov/dataset/1151/version/1st-anniversary";
	String dataset1151NameSpace = "http://logd.tw.rpi.edu/source/data-gov/dataset/1151/version/1st-anniversary";
	String commonPrefix = "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> "
	...
	String dataset1150Prefix = " PREFIX ds1150_global_value: <http://logd.tw.rpi.edu/source/data-gov/dataset/1150/> "
	...
	String dataset1151Prefix = " PREFIX ds1151_vocab: <http://logd.tw.rpi.edu/source/data-gov/dataset/1151/vocab/> "
	...
	public void issueSPARQLQuery(String queryString, Model model,
			OutputStream out) {
		...
		ResultSetFormatter.out(out, response, query);
